...
public class TelegramBot extends TelegramLongPollingBot {
        ...
        if (update.hasMessage() && update.getMessage().hasText()) {
            ...
            switch (messageText) {
                case START_COMMAND:
                    ...
                    this.createPhotoAndMessage(update.getMessage(), START_TEXT, "ru/cheb/service/img.png");
    ...
    private void createPhoto(Message message) {
        ...
        photo1.setMedia(new File("ru/cheb/service/photo_2025-02-28_20-32-01.jpg"), "photo1.jpg");
        mediaList.add(photo1);

        InputMediaPhoto photo2 = new InputMediaPhoto();
        photo2.setMedia(new File("ru/cheb/service/photo_2025-02-28_20-32-02.jpg"), "photo2.jpg");
        mediaList.add(photo2);

        InputMediaPhoto photo3 = new InputMediaPhoto();
        photo3.setMedia(new File("ru/cheb/service/photo_2025-02-28_20-32-03.jpg"), "photo3.jpg");
        mediaList.add(photo3);

        InputMediaPhoto photo4 = new InputMediaPhoto();
        photo4.setMedia(new File("ru/cheb/service/photo_2025-02-28_20-32-04.jpg"), "photo4.jpg");
